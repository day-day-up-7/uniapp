...
<script>
	...
	import { reqSearchproduct, reqHomeproduct, reqCarousel } from '../../API/index.js'
	...
	export default {
		...
		methods: {
			...
			async initProductList() {
				const result = await reqHomeproduct(this.number, this.pageNo)
			...
			async initCarousel() {
				...
				this.imageUrl = result.data.data
			}
		},
		computed:{
			...mapState(['menuBarUrl'])
